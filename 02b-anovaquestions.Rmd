...
"Does exposure to various food types lead to different moral expectations?"  The primary question from the [Organic Food Case Study](#CaseOrganic) is primarily about the relationship between two variables: the response (moral expectations; see Definition \@ref(def:defn-response)) and the __factor__ of interest (food type).
