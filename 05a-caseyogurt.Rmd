...
# Case Study: Paying a Premium for the Experience {#CaseYogurt}
...
```{r caseyogurt-table, echo=FALSE}
yogurt.df %>%
  rename(`Taste Rating` = Taste,
         `Texture Rating` = Texture,
         `Appearance Rating` = Appearance) %>%
  knitr::kable(caption = "Subset of data from blind taste test comparing the qualities of frozen yogurt across three vendors.")
```
