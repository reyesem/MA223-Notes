...
If we are going to have some amount of faith in the statistical results we produce, we must have data in which we can place our trust.  _The Treachery of Images_ (Figure @\ref(fig:data-pipe-img)) is a canvas painting depicting a pipe, below which the artist wrote the French phrase for "This is not a pipe."  Regarding the painting, the artist said
